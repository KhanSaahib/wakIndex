...
.mascot-name{{display:inline-block;margin:1rem 0 0;padding:.3rem .6rem;border:1px solid #3e7f70;border-radius:999px;color:#72f1c5;font:700 .72rem ui-monospace,monospace;letter-spacing:.14em}}
.tagline{{margin:.65rem 0 0;color:#b9d7cf;letter-spacing:.04em}}.content{{padding:2rem}}
...
<p class="mascot-name">{html.escape(MASCOT_NAME)}</p>
